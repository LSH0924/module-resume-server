...
func newProject(db *gorm.DB, opts ...gen.DOOption) project {
	...
	_project.UsersID = field.NewInt64(tableName, "users_id")
	_project.WorkExperiencesID = field.NewInt64(tableName, "work_experiences_id")
	_project.Title = field.NewString(tableName, "title")
	_project.Description = field.NewString(tableName, "description")
	_project.Role = field.NewString(tableName, "role")
...
func (p *project) updateTableName(table string) *project {
	...
	p.UsersID = field.NewInt64(table, "users_id")
	p.WorkExperiencesID = field.NewInt64(table, "work_experiences_id")
...
func (p *project) fillFieldMap() {
	...
	p.fieldMap["id"] = p.ID
	p.fieldMap["users_id"] = p.UsersID
	p.fieldMap["work_experiences_id"] = p.WorkExperiencesID
