...
func newCertificate(db *gorm.DB, opts ...gen.DOOption) certificate {
	...
	_certificate.UsersID = field.NewInt64(tableName, "users_id")
	_certificate.Name = field.NewString(tableName, "name")
	_certificate.IssuedBy = field.NewString(tableName, "issued_by")
	_certificate.IssuedDate = field.NewTime(tableName, "issued_date")
	_certificate.ExpirationDate = field.NewTime(tableName, "expiration_date")
...
type certificate struct {
	...
	UsersID        field.Int64
	Name           field.String
	IssuedBy       field.String
	IssuedDate     field.Time
...
func (c *certificate) updateTableName(table string) *certificate {
	...
	c.IssuedDate = field.NewTime(table, "issued_date")
	c.ExpirationDate = field.NewTime(table, "expiration_date")
...
func (c *certificate) fillFieldMap() {
	...
	c.fieldMap["issued_date"] = c.IssuedDate
	c.fieldMap["expiration_date"] = c.ExpirationDate
